...
DROP INDEX IF EXISTS idx_election_co_admins_email CASCADE;
DROP INDEX IF EXISTS idx_election_co_admins_election CASCADE;
...
DROP TABLE IF EXISTS election_co_admins CASCADE;
