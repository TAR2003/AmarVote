...
CREATE TABLE IF NOT EXISTS authorized_users (
    ...
    api_log_viewer_allowed BOOLEAN NOT NULL DEFAULT FALSE,
...
ALTER TABLE IF EXISTS authorized_users ADD COLUMN IF NOT EXISTS api_log_viewer_allowed BOOLEAN NOT NULL DEFAULT FALSE;
...
-- Vote receipts (no voter email stored — access via signed download token)
